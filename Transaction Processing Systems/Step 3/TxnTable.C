...
bool TxnTable::updateTxnRecord(int transID, int state, int firstLSN, int lastLSN, int undoNxtLSN) {
	...
	records[index].firstLSN = firstLSN;
	records[index].lastLSN = lastLSN;
	records[index].undoNxtLSN = undoNxtLSN;
